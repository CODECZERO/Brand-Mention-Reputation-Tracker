...
ARG FRONTEND_API_URL=http://localhost:4000
ARG FRONTEND_BRAND_ENDPOINT=http://localhost:4000/brand
ARG FRONTEND_ORCHESTRATOR_URL=http://localhost:3003
ARG FRONTEND_AGGREGATOR_URL=http://localhost:3001
ARG FRONTEND_WORKER_URL=http://localhost:3004
